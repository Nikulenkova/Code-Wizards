...
const DonutChart = () => (
  <div className='DonutChart-conteiner'>
    <h3 className='text-DonutChart'>Категории обращений</h3>
    <div className='DonutChart-conteiner1'>
      ...
      <div className='DonutChart-conteiner2'>
        <ul style={{ listStyleType: 'none', padding: 0 }}>
          {data.map((entry, index) => (
            <li key={`item-${index}`} style={{ display: 'flex', alignItems: 'center', marginBottom: '8px', fontSize:'1vw' }}>
